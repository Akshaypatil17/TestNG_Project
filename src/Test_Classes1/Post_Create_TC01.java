...
public class Post_Create_TC01 
{
	...
	{
		int statuscode = Post_API_Methods.ResponseStatusCode(Post_Create_Repo.BaseURI(),Post_Create_Repo.Post_Resource(), Post_Create_Repo.Post_Req_TC01());
		System.out.println(statuscode);
		
		String ResponseBody = Post_API_Methods.ResponseBody(Post_Create_Repo.BaseURI(),Post_Create_Repo.Post_Resource(), Post_Create_Repo.Post_Req_TC01());
